...
pub struct PipelineDeclaration {
    ...
    pub mode: PipelineDeclMode,
}

pub fn extract_pipeline_declaration(expr: &str) -> (Option<PipelineDeclaration>, String) {
    let commands = split_pipeline_commands_owned(expr);
